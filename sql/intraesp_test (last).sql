...
--
-- Client :  127.0.0.1
-- Généré le :  Sam 22 Novembre 2014 à 03:31
...
CREATE TABLE IF NOT EXISTS `affectation` (
  ...
  `CMEff` int(30) DEFAULT NULL,
  `CMAff` int(30) DEFAULT NULL,
  `TP` int(30) DEFAULT NULL,
  `TPEff` int(30) NOT NULL,
  `TPAff` int(30) DEFAULT NULL,
  `TD` int(30) DEFAULT NULL,
  `TDEff` int(30) NOT NULL,
  `TDAff` int(30) DEFAULT NULL,
...
INSERT INTO `affectation` (`idAffectation`, `idMatiere`, `idAgent`, `CM`, `CMEff`, `CMAff`, `TP`, `TPEff`, `TPAff`, `TD`, `TDEff`, `TDAff`) VALUES
(31, 24, 759, 0, 0, 0, 0, 0, 0, 30, 0, 30),
(34, 18, 717, 6, 6, 8, 0, 0, 0, 5, 7, 10),
(35, 14, 781, 10, 10, 10, 0, -2, 0, 5, 5, 5),
(36, 14, 783, 5, NULL, 5, 0, 0, 0, 5, 0, 5);
...
INSERT INTO `agents` (`idAgent`, `nom`, `prenom`, `matricule`, `Fonction`, `idTypeAgent`, `idGrade`, `idStructure`, `telephone`, `email`, `password`) VALUES
(177, 'ANNE', 'Alkassoume Abdoulaye', '100 136/C', 'Maint. Atel. Encad.TP', 3, 50, NULL, '77 652 83 67', 'kassoum10@gmail.com', '100 136/C'),
(178, 'AW', 'Penda  Houléye Marceline', '100 075/C', 'Responsable des Dépenses', 3, 49, 11, '77 528 19 40', 'awsyfr@yahoo.fr', '100 075/C'),
(179, 'BA', 'Tidiane Amadou', '100 311/B', 'Vaguemestre', 3, 52, NULL, '77 658 31 43', 'néant', '100 311/B'),
(180, 'BA', 'Yaya', '106 355/D', 'Vaguemestre', 3, 47, 12, '77 808 42 89', 'néant', '106 355/D'),
(181, 'BADIANE', 'Aladji', '100 336/E', 'Souffleur de verre', 3, 54, NULL, '77 501 75 56', 'albadiane58@yahoo,fr', '100 336/E'),
(182, 'BADJI', 'Mamadou Lamine', '100 373/B', 'Agent nett. chargé du débit mat.', 3, 55, NULL, '77 237 70 57', 'laizobadji@yahoo.fr', '100 373/B'),
(183, 'BADJI', 'Safiétou', NULL, 'Vaguemestre', 4, 77, NULL, '77 536 90 71', 'safietoubadji@yahoo.fr', ''),
(184, 'BARO', 'Pathé', '100 163/C', 'Electro. & syst. Infor', 3, 50, NULL, '77 568 09 72', 'pbaro77@yahoo.fr', '100 163/C'),
(185, 'BASSENE', 'Médard', '100 554/C', 'Maintenance machines Administrateur réseau, système', 3, 50, NULL, '77 646 58 97', 'mdrbassene@gmail.com', '100 554/C'),
(186, 'BOCOUM', 'Fatoumata', '100 380/F', '', 3, 47, NULL, '77 947 46 52', 'néant', '100 380/F'),
(187, 'BODIAN', 'Bakary', '100 671/A', 'Electricien', 3, 56, 15, NULL, NULL, '100 671/A'),
(188, 'BOYE', 'Abdel Aziz', '102 942/D', 'Réalisateur', 3, 57, 16, '76 330 92 07', 'abdelazizboye@yahoo.fr', '102 942/D'),
(189, 'CAMARA', 'Papa Arona', '100 788/F', 'Photographe - Caméraman', 3, 58, 17, '77 412 04 90', 'ronecamara1@yahoo.fr', '100 788/F'),
(190, 'CISS', 'Ousseynou', '100 948/L', 'Chauffeur', 3, 57, 18, '77 242 15 26', 'néant', '100 948/L'),
(191, 'CISSE', 'Anne Marie', '100 926/L', 'Secrétaire', 3, 59, NULL, '77 567 66 04', 'annemariecisse@yahoo.fr', '100 926/L'),
(192, 'CISSE', 'Oumar', '100 593/B', '', 3, 60, NULL, NULL, NULL, '100 593/B'),
(193, 'CISSE', 'Papa Ousmane', NULL, 'Techn. Supérieur en informatique', 4, 77, NULL, '77 301 08 44', 'cissepoc@yahoo.fr', ''),
(194, 'DANSOKHO', 'Malamine', '101 095/F', 'Agent de service', 3, 47, 30, '77 559 40 97   ', 'néant', '101 095/F'),
(195, 'DANSOKHO', 'Mankama', '106 389/C', '', 3, 52, NULL, '77 539 33 24   ', 'makama.dansokho@yahoo.fr', '106 389/C'),
(196, 'DIA', 'Mamadou', '101 228/F', 'Vaguemestre', 3, 47, NULL, '77 636 54 45   ', 'badou.dia@yahoo.fr', '101 228/F'),
(197, 'DIACK', 'Moctar', '_', '', 3, 77, NULL, '77 376 28 66', 'diack95@hotmail.com', '_'),
(198, 'DIAGNE', 'Dieynaba Mané', '_', 'Secrétaire', 3, 77, NULL, '77 573 90 17', 'dieynabam@gmail.com', '_'),
(199, 'DIAGNE', 'Djily Mbaye', '100 729/M', 'Comptable', 3, 49, NULL, '77 592 40 92   ', 'djily_d@hotmail.com', '100 729/M'),
(200, 'DIAGNE', 'Mamadou', '101 299/Z', 'Préposé au prêt', 3, 62, NULL, '77 272 08 98', 'néant', '101 299/Z'),
(201, 'DIAGNE', 'Yamar', '101 406/H', 'Adjoint Resp. fich. Scolarité', 3, 52, 22, '77 650 11 57', 'yamdia2002@yahoo.fr', '101 406/H'),
(202, 'DIAKHATE', 'Sokhna Ka', '104 213/A', 'Secrétaire', 3, 61, 23, '77 550 39 09', 'skdiakhate@yahoo.fr', '104 213/A'),
(203, 'DIAKO', 'Ibrahima', '100 301/C', 'Chauffeur', 3, 62, 18, '77 678 33 27', 'néant', '100 301/C'),
(204, 'DIALLO', 'Aïssatou Bouna', '100 962/D', 'Secrétaire', 3, 59, 24, '77 630 95 10', 'astoubouna2000@yahoo.fr', '100 962/D'),
(205, 'DIALLO', 'Fatoumata Binta', '106 359/Z', 'Assistante de Direction', 3, 63, NULL, '77 543 10 03', 'binou.diallo@gmail.com', '106 359/Z'),
(206, 'DIALLO', 'Khadizatou Fall', '102 069/Z', 'Resp. Publications en série', 3, 64, NULL, '77 541 70 57', 'khadyfa@hotmail.fr', '102 069/Z'),
(207, 'DIALLO', 'Oumar Samba', '101 542/A', 'Electricien', 3, 56, 15, '77 655 72 30', 'néant', '101 542/A'),
(208, 'DIALLO', 'Papa Taïr', '101 404/P', 'Chef du Service des Approvisionnements', 3, 49, 25, '77 521 29 16', 'billydi53@yahoo.fr', '101 404/P'),
(209, 'DIATTA', 'Hèlène', '101 195/E', 'Assistance pédagogique', 3, 49, NULL, '77 568 08 07', NULL, '101 195/E'),
(210, 'DIATTA', 'Mariama Dramé', '100 478/D', 'Technicienne', 3, 63, NULL, '77 617 97 28   ', 'mayana832003@yahoo.fr', '100 478/D'),
(211, 'DIATTA', 'Ngoné Niang', '102 213/A', 'TP & Maint. Labo Autom', 3, 63, NULL, '77 505 88 11', 'ngoneniang@yahoo.fr', '102 213/A'),
(212, 'DIEDHIOU', 'Djibril', '101 662/Z', 'Aide-infirmier', 3, 62, 26, '77 539 41 95', 'néant', '101 662/Z'),
(213, 'DIEDHIOU', 'Saly', '101 663/A', 'Agent de nettoiement', 3, 62, NULL, '77 376 85 33', 'néant', '101 663/A'),
(214, 'DIENG', 'Salif', '101 312/B', 'Superviseur espaces verts', 3, 62, 13, '77 650 09 95', 'néant', '101 312/B'),
(215, 'DIENG', 'Thiadji', '101 763/B', 'Secrétaire', 3, 49, NULL, '77 611 77 57', 'dthiadji@yahoo.fr', '101 763/B'),
(216, 'DIEYE', 'Safiétou Ly', '102 826/I', 'Chargée de la saisie', 3, 61, NULL, '77 537 96 76', 'sofi_ly@hotmai.fr', '102 826/I'),
(217, 'DIONE', 'Eve Madeleine Alice', '106 398/E', 'Assistante', 3, 49, 27, '77 517 03 62', 'dioneeva@gmail.com', '106 398/E'),
(218, 'DIOP', 'Mame Diarra Pouye', '104 703/E', 'Responsable des recettes F.S', 3, 49, 11, '77 657 72 61', 'mdpouye@yahoo.fr', '104 703/E'),
(219, 'DIOP', 'Maréme', '106 021/H', 'Secrétaire', 3, 65, NULL, '77 630 38 53', 'diopmareme76@yahoo.fr', '106 021/H'),
(220, 'DIOP', 'Moctar', '100 533/D', 'Génie Chimique', 3, 66, NULL, '77 631 21 44', NULL, '100 533/D'),
(221, 'DIOP', 'Ndéye Adiara Ndiaye', '104 061/J', 'Labo Microbiologie', 3, 66, NULL, '77 640 60 58   ', 'ndadiara@hotmail.com', '104 061/J'),
(222, 'DIOP', 'Ousmane', '101 748/I', 'Agent Administratif', 3, 52, NULL, '77 730 84 49', NULL, '101 748/I'),
(223, 'DIOP', 'Ousmane Niébé', '514 648/B', 'CSA', 3, 67, NULL, '77 549 55 99   ', 'oniebe@yahoo.fr', '514 648/B'),
(224, 'DIOUF', 'Chérif', '106 339/D', 'Technicien', 3, 50, NULL, '77 425 50 09', 'dioufeolsenegal@yahoo.fr', '106 339/D'),
(225, 'DIOUF', 'Marie Henriette Mbengue', '_', 'Secrétaire', 3, 77, NULL, '77 630 09 38   ', 'henriettembengue12@yahoo.fr', '_'),
(226, 'FALL', 'Anna Gueye', '102 087/D', 'Secrétaire Caissiére', 3, 59, NULL, '77 553 75 55', 'anna_gueye_fall@yahoo.fr', '102 087/D'),
(227, 'FALL', 'Elie', '100 667/F', 'CEMU', 3, 62, 17, '77 409 28 93', 'eliefall7@gmail.com', '100 667/F'),
(228, 'FALL', 'Madjiguéne', '102 216/D', '', 3, 49, 11, '77 524 92 31', 'mbaien@hotmail.com', '102 216/D'),
(229, 'FALL', 'Matar', '100 576/C', 'Reprographe', 3, 62, NULL, '77 517 75 54', 'fallmatar@yahoo.fr', '100 576/C'),
(230, 'FATY', 'Boubacar', '102 575/Z', 'Maintenance machines', 3, 66, NULL, '77 541 42 70   ', 'bfaty@ucad.sn', '102 575/Z'),
(231, 'FAYE', 'Louise Diouf', '100 681/B', 'Secrétaire du Chef de Département', 3, 61, NULL, '77 655 58 29', 'louise.diouf@ucad.edu.sn', '100 681/B'),
(232, 'FAYE', 'Louise Yande', '102 591/F', 'Secrétaire', 3, 61, NULL, '77 532 44 77', 'louloufaye@yahoo.fr', '102 591/F'),
(233, 'FAYE', 'Mama Tata Dia', '101 226/D', 'TP Chim. Inst. Alim. Ch . Gén', 3, 63, NULL, '77 630 11 31', NULL, '101 226/D'),
(234, 'GNINGUE', 'Khadidiatou Diop', '101 496/A', 'Secretaire', 3, 59, 22, '77 306 82 56', 'kdg552003@yahoo.fr', '101 496/A'),
(235, 'GNINGUE', 'Seynabou Faye', '102 164/D', 'Secretaire', 3, 59, NULL, '77 540 79 86', 'naboubada15@yahoo.fr', '102 164/D'),
(236, 'GOUDIABY', 'Youssouf', '102 362/D', 'Magasinier', 3, 69, NULL, '77 503 73 25', NULL, '102 362/D'),
(237, 'GUEYE', 'Amadou Moustapha', '102 589/C', 'Chauffeur', 3, 62, NULL, '77 573 99 14', 'néant', '102 589/C'),
(238, 'GUEYE', 'Awa Boubou SALL', '104 223/B', 'Analys, Physico-chimiques', 3, 66, 24, '77 510 72 99', 'hawasall@yahoo.fr', '104 223/B'),
(239, 'GUEYE', 'Mbarou NDIAYE', '103 396/D', 'Aide laboratoire', 3, 70, NULL, '77 650 87 71   ', 'néant', '103 396/D'),
(240, 'HANNE', 'Aminata', '106 191/N', 'Technicienne Supérieure', 3, 63, NULL, '77 445 81 17', 'Natah2000@hotmail.com', '106 191/N'),
(241, 'HANNE', 'Dior Dieng', '101 764/C', 'TP Chim. Inst. Alim. Ch . Gén', 3, 63, NULL, '77 536 82 53', 'néant', '101 764/C'),
(242, 'KA', 'Adama', '102 622/C', 'Maintenance Informatique', 3, 66, NULL, '77 551 84 93', 'adama.ka@ucad n° 31', '102 622/C'),
(243, 'KABOU', 'Emmanuel', '102 626/G', 'Chef du Service SID', 3, 64, NULL, '77 642 19 96', 'ekabou@yahoo.fr', '102 626/G'),
(244, 'KAMARA', 'Bineta', NULL, 'Assistante', 4, 77, NULL, '77 542 18 30', 'binetak@yahoo.fr', ''),
(245, 'KANE', 'Alé', '102 955/F', 'Laboratoire formation continue en Industrie Agro-alimentairre', 3, 66, NULL, '77 541 60 66', 'alekane11@yahoo.fr', '102 955/F'),
(246, 'KHARMA', 'Mouhamadou Lamine', '102 625/F', 'Chargé de mission', 3, 62, 18, '77 643 82 43   ', 'laminekharma@yahoo.fr', '102 625/F'),
(247, 'KOITA', 'Ndeye Mariama', '106 004/C', 'Aide Laboratoire', 3, 47, NULL, '76 632 23 01', 'mail non fonctionnel', '106 004/C'),
(248, 'LO', 'Libasse', '106 364/F', 'Caissier', 3, 71, 11, '77 653 01 46', 'l_libasse@yahoo.fr', '106 364/F'),
(249, 'LO', 'Ndeye Peinda Seye', '104 108/D', 'Secrétaire Caissiére', 3, 61, 11, '77 645 90 76', 'gmeca43@hotmail.com', '104 108/D'),
(250, 'LY', 'Bara', '102 825/H', 'Agent de liaison', 3, 62, 18, '77 651 87 60', 'néant', '102 825/H'),
(251, 'LY', 'Kheifate Ndiaye', '104 471/G', 'Technicienne', 3, 66, 29, NULL, 'boucoum@yahoo.fr', '104 471/G'),
(252, 'MANDIAME', 'Henriette Diagne', '100 281/F', 'Secrétaire', 3, 59, 22, '77 649 49 47   ', 'hdiagne@hotmail.fr', '100 281/F'),
(253, 'MANGA', 'Albert', '102 972/A', 'Standardiste', 3, 57, 30, '77 510 23 68', 'néant', '102 972/A'),
(254, 'MARIA', 'Bakary', '102 979/H', 'Chauffeur', 3, 62, 15, '77 650 48 43', 'néant', '102 979/H'),
(255, 'MBAYE', 'Mamadou', '_', 'Technicien', 3, 77, NULL, '77 502 48 62', 'mbaymama@gmail.com', '_'),
(256, 'MBAYE', 'Mame Lissa Badiane', '100 359/F', 'Secrétaire', 3, 59, 11, '77 216 31 36', 'mame.lissa@yahoo.fr', '100 359/F'),
(257, 'MBENGUE', 'Maria Yadiouf Ndiaye', '103 253/D', 'TP & Maint. Labo Electro.', 3, 66, NULL, '77 644 11 01', 'mariayadiouf_n@hotmail.com', '103 253/D'),
(258, 'MBENGUE', 'Marie Noelle', '103 155/C', 'Chef Service de la Scolarité', 3, 49, 22, '77 573 65 72', 'marino@ucad.sn', '103 155/C'),
(259, 'NDAW', 'Maguette', '104 588/Z', 'Electricien', 3, 52, 15, '77 558 29 72', 'mxabody@hotmail.fr', '104 588/Z'),
(260, 'NDIAYE', 'Aïda Diouf', '103 268/Z', 'Lingére', 3, 62, 15, '77 649 75 66', 'néant', '103 268/Z'),
(261, 'NDIAYE', 'Arame', '103 634/C', 'Responsable salle des présentoirs', 3, 52, NULL, '77 442 45 09   ', 'néant', '103 634/C'),
(262, 'NDIAYE', 'Balla', '101 961/A', 'Menuisier Metallique', 3, 62, NULL, '77 512 32 58', NULL, '101 961/A'),
(263, 'NDIAYE', 'Mamadou', '106 235/C', 'Chef du Service des Finances et de la Comptabilité', 3, 49, 11, '77 650 89 61', 'ndiayemamadou73@yahoo.fr', '106 235/C'),
(264, 'NDIAYE', 'Manatou Kane', '102 701/E', 'Secrétaire Directeur', 3, 59, 18, '77 565 23 87', 'kane_manatou@yahoo.fr', '102 701/E'),
(265, 'NDIAYE', 'Ousseynou', '106 358/A', 'Techncien', 3, 72, 17, '77 781 85 83', 'ouzzin4@hotmail.com', '106 358/A'),
(266, 'NDIAYE', 'Tamsir Malicke', '106 374/G', 'Agent de service', 3, 47, NULL, '77 322 60 80', NULL, '106 374/G'),
(267, 'NDIR', 'Khady  Diouf', '101 001/A', 'Secrétaire Directeur des Etudes', 3, 61, 12, '77 561 18 35', 'dkhadija@ucad.sn', '101 001/A'),
(268, 'NDIR', 'Malick', '106 356/C', '', 3, 62, NULL, '76 690 42 35   ', 'ndirmalick@yahoo.fr', '106 356/C'),
(269, 'NDOUR', 'Ibrahima', '104 308/F', 'Techn. Supérieur', 3, 50, NULL, '77 534 22 47', 'ibisndour@yahoo.fr', '104 308/F'),
(270, 'NDOUR', 'Ndéye Khady Virginie', '_', 'Comptable', 3, 77, NULL, '77 649 69 14', 'kvndour@yahoo.fr', '_'),
(271, 'NDOYE', 'Moussa', '103 254/C', 'Menuisier', 3, 62, NULL, '76 671 30 98', NULL, '103 254/C'),
(272, 'NGOM', 'Adama Diakhère', '106 190/O', 'Technicienne Supérieure', 3, 63, NULL, '77 613 49 22', 'cocoadu@gmail.com', '106 190/O'),
(273, 'NIANE', 'Seynabou Fall', '100 568/F', 'Secrétaire', 3, 49, NULL, '550 55 69', 'seynaboufall@hotmail.com', '100 568/F'),
(274, 'NIANG', 'Seynabou Dieng', '101 313/C', 'Secrétaire', 3, 59, 11, '77 636 84 35', 'naboudieng3000@yahoo.fr', '101 313/C'),
(275, 'NIASSY', 'Baboucar', '100 758/I', '', 3, 49, NULL, '77 556 23 52', 'bniassy2000@yahoo.fr', '100 758/I'),
(276, 'SAKHO', 'Mbaye', '103 778/D', 'Chauffeur du Directeur des Etudes', 3, 62, 12, '77 563 51 46   ', NULL, '103 778/D'),
(277, 'SAKHO', 'Volimata Sall', '104 259/A', 'Secrétaire', 3, 57, NULL, '77 785 65 63', 'salloulimata@yahoo.fr', '104 259/A'),
(278, 'SALL', 'Cheikh Ahmet Tidiane', '106 388/D', 'Agent de liaison', 3, 62, 11, '77 034 56 53', 'néant', '106 388/D'),
(279, 'SALL', 'Cheikh Tidiane', '100 509/M', '', 3, 49, 29, NULL, NULL, '100 509/M'),
(280, 'SAMB', 'Seyni Ndiaye', '103 374/D', 'Aide-infirmiére', 3, 52, 26, '77 557 23 07', 'néant', '103 374/D'),
(281, 'SANE', 'Ibrahima', '104 714/E', '', 3, 52, 22, '77 557 48 30', 'papissanefr@hotmail.com', '104 714/E'),
(282, 'SANE', 'Ibrahima Papia', '103 858/G', 'Agent de liaison', 3, 47, 13, '77 517 18 75   ', 'néant', '103 858/G'),
(283, 'SANE', 'Insa', '103 851/Z', 'Chargé de la maintenance', 3, 73, NULL, '33  825 75 28', 'babadisane@gmail.com', '103 851/Z'),
(284, 'SANE', 'Souleymane', '100 567/E', 'Informaticien', 3, 74, NULL, '77 650 28 35', 'jssane@gmail.com', '100 567/E'),
(285, 'SARR', 'Emilie Ndiaye', '103 377/A', 'Aide laboratoire', 3, 57, NULL, '77 549 99 07', 'néant', '103 377/A'),
(286, 'SECK', 'Abdourakhmane', '106 354/E', '', 3, 52, NULL, '76 395 23 23', NULL, '106 354/E'),
(287, 'SECK', 'Madiop', '104 211/C', '', 3, 49, NULL, '77 756 10 65', 'madiop.seck@ucad.edu.sn', '104 211/C'),
(288, 'SECK', 'Matar', '100 474/Z', 'Technicien', 3, 50, NULL, '77 456 27 24', 'seck.matar@gmail.com', '100 474/Z'),
(289, 'SECK', 'Samba', '_', 'Plombier', 3, 77, NULL, '77 651 52 78', 'néant', '_'),
(290, 'SEYDI', 'Ismaîla', '104 261/H', 'Electricien', 3, 62, 15, '77 100 34 06', 'papiseydi@live.fr', '104 261/H'),
(291, 'SEYDI', 'Souleymane', '104 581/G', 'Préposé au prêt', 3, 76, NULL, '77 539 60 89   ', 'seydi31@yahoo.fr', '104 581/G'),
(292, 'SOW', 'Mariama Soda Rosa', '_', 'Assistante', 3, 77, NULL, '77 520 37 50', 'rosa_sow@yahoo.fr', '_'),
(293, 'SOW', 'Mbacké', '104 073/I', 'Menuisier', 3, 52, 15, '77 373 84 09', 'néant', '104 073/I'),
(294, 'SY', 'Samba Ciré', '104 535/B', 'Techncien', 3, 50, NULL, '77 532 60 08', 'sambaciresy@yahoo.fr', '104 535/B'),
(295, 'TALL', 'Oumar', '104 677/A', 'Chauffeur', 3, 62, 15, '77 659 97 79', 'néant', '104 677/A'),
(296, 'TAMBA', 'Seydou', '104 645/B', 'Aide-frigoriste', 3, 62, NULL, '77 654 43 25', 'néant', '104 645/B'),
(297, 'THIAM', 'Mamadou Mamoudou', '104 762/B', 'Charg.cont.entrées/sorties', 3, 62, NULL, '77 650 62 47   ', 'maothiam2003@yahoo.fr', '104 762/B'),
(298, 'THIAM', 'Mbissane', '104 687/Z', 'Assistante Pédagogique', 3, 61, NULL, '77 655 82 99', 'tmbissane@hotmail.com', '104 687/Z'),
(299, 'THIAM', 'Momar', '106 012/F', '', 3, 52, 22, '77 905 77 36   ', 'momarthiam50@gmail.com', '106 012/F'),
(300, 'THIAM', 'Mouhamadou', '104 378/A', 'Equi. Elec. Et Autom. Indus', 3, 66, NULL, '70 703 78 09   ', 'mouhamadou_thiam80@hotmail.com', '104 378/A'),
(301, 'THIAM', 'Nogoye Diop', '101 814/I', 'Secrétaire', 3, 49, 17, '77 568 07 45', 'nogaye@ucad.sn', '101 814/I'),
(302, 'THIAM', 'Kadeidiata Toubra', '104 708/J', 'Agent de nettoiement', 3, 47, 15, '77 563 76 47', 'néant', '104 708/J'),
(303, 'THIAW', 'Cany Sall', '104 916/I', 'Chef du Service Comptabilité Matiéres', 3, 49, 30, '77 632 62 95', 'kanysall@hotmail.fr', '104 916/I'),
(304, 'THIOUNE', 'Awa Kâ', '104 908/L', 'Chef du Service des Ressources Humaines', 3, 61, 13, '77 029 81 06', 'awambka@yahoo.fr', '104 908/L'),
(305, 'TOURE', 'Cheikh Ahmadou Mbacké', '104 849/H', 'Chef du bureau Audit et Contrôle', 3, 49, NULL, '77 872 13 36   ', 'tourval@yahoo.fr', '104 849/H'),
(306, 'TOURE', 'Rokhaya Sow', '_', 'Secrétaire', 3, 77, NULL, '77 270 34 51', 'rokhayast@hotmail.fr', '_'),
(307, 'WELE', 'Abou', '105 008/E', 'Assistant au CEPECS', 3, 52, NULL, '77 630 08 45', 'weleabou@yahoo.fr', '105 008/E'),
(686, 'ADJ', 'Mamadou', '100 045/Z', 'Enseignant-Chercheur', 1, 1, 4, '77 819 62 00', NULL, 'passer'),
(687, 'AGNE', 'Alassane Elfecky', '100 063/D', 'Enseignant-Chercheur', 1, 2, 5, '77 681 81 98', NULL, '100 063/D'),
(688, 'ANNE', 'Cheikh Oumar', '100 065/B', 'Enseignant-Chercheur', 1, 2, 6, '77 332 00 43', NULL, '100 065/B'),
(689, 'AYESSOU', 'Nicolas', '100 198/A', 'Enseignant-Chercheur', 1, 3, 6, '77 251 48 48', NULL, '100 198/A'),
(690, 'AZILINON', 'Dorothé B.', '100 101/A', 'Enseignant-Chercheur', 1, 1, 7, '77 555 33 71', NULL, '100 101/A'),
(691, 'BA', 'Oumar', '510 434/A', 'Enseignant-Chercheur', 1, 4, 4, '77 639 46 62', NULL, '510 434/A'),
(692, 'BADIANE', 'Daouda', '100 337/F', 'Enseignant-Chercheur', 1, 2, 8, '77 654 73 44', NULL, '100 337/F'),
(693, 'BAH', 'Alassane', '100 166/Z', 'Enseignant-Chercheur', 1, 3, 8, '77 641 42 99', NULL, '100 166/Z'),
(694, 'BALDE', 'Mamadou', '100 406/I', 'Enseignant-Chercheur', 1, 3, 6, '77 552 20 80', NULL, '100 406/I'),
(695, 'BALDE', 'Samba', '100 213/C', 'Enseignant-Chercheur', 1, 2, 8, '77 534 79 40', NULL, '100 213/C'),
(696, 'BAMPOKY', 'Boniface', '100 482/C', 'Enseignant-Chercheur', 1, 3, 5, '77 565 28 57', NULL, '100 482/C'),
(697, 'CAMARA', 'Mamadou Samba', '106 293 /', 'Enseignant-Chercheur', 1, 5, 8, '77 395 54 22', NULL, '106 293 /'),
(698, 'CISSE', 'Mady', '100 754/E', 'Enseignant-Chercheur', 1, 2, 6, '77 378 72 40', NULL, '100 754/E'),
(699, 'CORENTHIN', 'Alex Louis', '101 034/A', 'Enseignant-Chercheur', 1, 2, 8, '77 631 77 76', NULL, '101 034/A'),
(700, 'COULIBALY', 'Hamidou', '101 060/H', 'Enseignant-Chercheur', 1, 3, 5, NULL, NULL, '101 060/H'),
(701, 'DIALLO', 'Mamadou Salif', '357 858/F', 'Enseignant-Chercheur', 1, 6, 9, '77 659 40 74', NULL, '357 858/F'),
(702, 'DIENE', 'Aminata Diop', '101 154/B', 'Enseignant-Chercheur', 1, 5, 8, '77 641 32 35', NULL, '101 154/B'),
(703, 'DIENG', 'Modou', '102 223/Z', 'Enseignant-Chercheur', 1, 7, 6, '77 630 46 07', NULL, '102 223/Z'),
(704, 'DIEYE', 'Ngagne', '101 671/B', 'Enseignant-Chercheur', 1, 2, 4, '77 655 25 51', NULL, '101 671/B'),
(705, 'DIONG', 'Mamadou', '101 734/F', 'Enseignant-Chercheur', 1, 5, 5, '77 654 43 84', NULL, '101 734/F'),
(706, 'DIOP', 'Christiane Romain', '103 703/F', 'Enseignant-Chercheur', 1, 7, 10, NULL, NULL, '103 703/F'),
(707, 'DIOP', 'Codou Gueye Mar', '102 975/D', 'Enseignant-Chercheur', 1, 8, 6, '77 630 96 46', NULL, '102 975/D'),
(708, 'DIOP', 'Magaye', '101 497/Z', 'Enseignant-Chercheur', 1, 2, 4, '77 643 69 58', NULL, '101 497/Z'),
(709, 'DIOP', 'Mbaye', '101 056/A', 'Enseignant-Chercheur', 1, 5, 10, '77 554 07 17  7', NULL, '101 056/A'),
(710, 'DIOP', 'Moussa', '101 946/I', 'Enseignant-Chercheur', 1, 5, 5, '77 567 71 82', NULL, '101 946/I'),
(711, 'DIOUM', 'Ibra', '100 468/E', 'Enseignant-Chercheur', 1, 5, 8, '77 531 27 10', NULL, '100 468/E'),
(712, 'FALL', 'Amadou Amdy', '106415/A', 'Enseignant-Chercheur', 1, 5, 5, '77 534 86 65', NULL, '106415/A'),
(713, 'FALL', 'Aynina', '102 042/E', 'Enseignant-Chercheur', 1, 5, 5, '77 176 67 00', NULL, '102 042/E'),
(714, 'FALL', 'Ibrahima', '100 335/D', 'Enseignant-Chercheur', 1, 5, 8, '77 531 40 37', NULL, '100 335/D'),
(715, 'FALL', 'Ndeye Maguette', '100 282/E', 'Enseignant-Chercheur', 1, 5, 10, '77 639 63 07', NULL, '100 282/E'),
(716, 'FALL', 'Oumar', '102 047/Z', 'Enseignant-Chercheur', 1, 5, 8, '77 658 24 52', NULL, '102 047/Z'),
(717, 'FALL', 'Salif Sagana', '102 491/G', 'Enseignant-Chercheur', 1, 5, 4, '77 536 81 43', NULL, '102 491/G'),
(718, 'FARSSI', 'Sidi Mohamed', '102 222 /', 'Enseignant-Chercheur', 1, 9, 8, '77 637 16 37', NULL, '102 222 /'),
(719, 'FAYE', 'Mamadou', '106 291/M', 'Enseignant-Chercheur', 1, 5, 6, '77 560 57 83', NULL, '106 291/M'),
(720, 'FAYE', 'Roger Marcellin', '102 274/F', 'Enseignant-Chercheur', 1, 9, 4, '77 536 50 20', NULL, 'passer'),
(721, 'GAYE', 'Amadou Thierno', '102 530/A', 'Enseignant-Chercheur', 1, 9, 8, '77 578 28 38   ', NULL, '102 530/A'),
(722, 'GOUDIABY', 'Chérif Ibrahima', '381 712/L', 'Enseignant-Chercheur', 1, 7, 10, '77 573 22 56 ', NULL, '381 712/L'),
(723, 'GUEYE', 'Amadou Moctar', '386 842/E', 'Enseignant-Chercheur', 1, 7, 7, '77 503 64 66', NULL, '386 842/E'),
(724, 'HANNE', 'Ibrahima', '102 554/F', 'Enseignant-Chercheur', 1, 10, 5, '77 418 00 26', NULL, '102 554/F'),
(725, 'JANANTO', 'Pierre', '102 595/B', 'Enseignant-Chercheur', 1, 3, 5, '77 510 80 12', NULL, '102 595/B'),
(726, 'KA', 'Oury', '353 621/D', 'Enseignant-Chercheur', 1, 7, 8, '77 545 14 11', NULL, '353 621/D'),
(727, 'KAMARA', 'Lioudmila F. Pavlovskaya', '607 689 /', 'Enseignant-Chercheur', 1, 2, 7, '77 515 26 38', NULL, '607 689 /'),
(728, 'KANE', 'Cheikhou', '100 734/G', 'Enseignant-Chercheur', 1, 3, 6, '77 148 79 61', NULL, '100 734/G'),
(729, 'KEBE', 'Mohamed Fadel', '102 604/G', 'Enseignant-Chercheur', 1, 2, 10, '77 819 29 09', NULL, '102 604/G'),
(730, 'KEINDE', 'Dame', '100 596/A', 'Enseignant-Chercheur', 1, 5, 10, '77 273 42 79 77', NULL, '100 596/A'),
(731, 'KEITA', 'Khadidiatou Wane', '104 989/E', 'Enseignant-Chercheur', 1, 5, 8, '77 548 38 41', NULL, '104 989/E'),
(732, 'KOITA', 'Démo', '103 942/C', 'Enseignant-Chercheur', 1, 2, 6, '76 693 81 91', NULL, '103 942/C'),
(733, 'LISHOU', 'Claude', '102 854/D', 'Enseignant-Chercheur', 1, 1, 4, '77 638 41 85  7', NULL, '102 854/D'),
(734, 'LO', 'Sidi Mambaye', '102 853/C', 'Enseignant-Chercheur', 1, 11, 4, '77 650 63 34', NULL, 'passer'),
(735, 'MALOU', 'Paul', '102 896/B', 'Enseignant-Chercheur', 1, 2, 7, '76 664 69 02', NULL, '102 896/B'),
(736, 'MANDIANG', 'Youssouf', '102 964/D', 'Enseignant-Chercheur', 1, 11, 7, '77 532 59 72', NULL, '102 964/D'),
(737, 'MBACKE', 'Ahmath Bamba', '104 433/A', 'Enseignant-Chercheur', 1, 5, 8, '77 575 64 90', NULL, '104 433/A'),
(738, 'MBAYE', 'Abibou', '103 037/Z', 'Enseignant-Chercheur', 1, 10, 5, '77 654 43 82', NULL, '103 037/Z'),
(739, 'MBAYE', 'Cheikh Tidiane', '103 047/A', 'Enseignant-Chercheur', 1, 11, 6, '77 572 71 38', NULL, '103 047/A'),
(740, 'MBENGUE', 'Malick', '104 417/E', 'Enseignant-Chercheur', 1, 3, 6, '77 653 28 81', NULL, '104 417/E'),
(741, 'MBOUP', 'Alioune Badara', '601 642/C', 'Enseignant-Chercheur', 1, 4, 4, '77 637 37 69', NULL, '601 642/C'),
(742, 'MENDY', 'Gervais', '101 045/A', 'Enseignant-Chercheur', 1, 5, 8, '70 100 65 02', NULL, '101 045/A'),
(743, 'NDIAYE', 'Abdoulaye', '508 187/M', 'Enseignant-Chercheur', 1, 12, 7, '77 654 26 28', NULL, '508 187/M'),
(744, 'NDIAYE', 'Mamadou', '103 121/D', 'Enseignant-Chercheur', 1, 2, 7, '77 433 98 65', NULL, '103 121/D'),
(745, 'NDIAYE', 'Mamadou Lamine', '100 985/E', 'Enseignant-Chercheur', 1, 3, 4, '77 111 68 70', NULL, '100 985/E'),
(746, 'NDIAYE', 'Mame Mor Diarra', '602 211/F', 'Enseignant-Chercheur', 1, 4, 7, '77 649 63 11', NULL, '602 211/F'),
(747, 'NDIAYE', 'Mouhamadou Falilou', '104 047/B', 'Enseignant-Chercheur', 1, 5, 4, '77 657 46 71', NULL, '104 047/B'),
(748, 'NDIAYE', 'Ndiaga', '106 347/A', 'Enseignant-Chercheur', 1, 5, 5, '77 442 37 37', NULL, '106 347/A'),
(749, 'NDIAYE', 'Papa Alioune Sarr', '103 346/A', 'Enseignant-Chercheur', 1, 11, 4, '77 819 60 01', NULL, '103 346/A'),
(750, 'NDIAYE', 'Seydi Ababacar', '103 199/C', 'Enseignant-Chercheur', 1, 2, 6, '77 648 10 00', NULL, '103 199/C'),
(751, 'NDIAYE', 'Talla', '103 453/B', 'Enseignant-Chercheur', 1, 7, 4, '77 310 67 76', NULL, '103 453/B'),
(752, 'NDOYE', 'Djibril', '103 493/F', 'Enseignant-Chercheur', 1, 3, 5, '77 743 33 83', NULL, '103 493/F'),
(753, 'NDOYE', 'Mame Moussé', '103 537/E', 'Enseignant-Chercheur', 1, 3, 5, '77 639 50 83', NULL, '103 537/E'),
(754, 'NDOYE', 'Seyni', '102 963/C', 'Enseignant-Chercheur', 1, 2, 10, '77 557 73 49 77', NULL, '102 963/C'),
(755, 'NGOM', 'Blaise', '103 539/G', 'Enseignant-Chercheur', 1, 2, 6, '77 634 39 56', NULL, '103 539/G'),
(756, 'NGOM', 'El Hadji Abib', '103 534/B', 'Enseignant-Chercheur', 1, 1, 4, '77 638 45 02', NULL, '103 534/B'),
(757, 'NGOM', 'Ibrahima', '104 424/A', 'Enseignant-Chercheur', 1, 5, 8, '77 655 50 39', NULL, '104 424/A'),
(758, 'NGUER', 'Cheikh Momar', '102 614/F', 'Enseignant-Chercheur', 1, 2, 6, '77 540 57 27', NULL, '102 614/F'),
(759, 'NIANG', 'Ababacar', '103 669/E', 'Enseignant-Chercheur', 1, 2, 4, '77 542 54 30', NULL, '103 669/E'),
(760, 'NIANG', 'Awa', '103 128/C', 'Enseignant-Chercheur', 1, 11, 7, '77 642 55 16', NULL, '103 128/C'),
(761, 'NIANG', 'Boubacar', '510 443/A', 'Enseignant-Chercheur', 1, 2, 4, '77 576 69 33', NULL, '510 443/A'),
(762, 'NIANG', 'Libasse', '103 564/A', 'Enseignant-Chercheur', 1, 10, 5, '77100 29 23', NULL, '103 564/A'),
(763, 'NIANG', 'Mamadou', '103 119/E', 'Enseignant-Chercheur', 1, 2, 8, '77 531 62 62', NULL, '103 119/E'),
(764, 'NJIE', 'Codou Mbassy Diene', '101 668/F', 'Enseignant-Chercheur', 1, 3, 4, '77 637 65 44', NULL, '101 668/F'),
(765, 'OUYA', 'Samuel', '103 614/E', 'Enseignant-Chercheur', 1, 2, 8, '77 637 27 89', NULL, '103 614/E'),
(766, 'SAKHO', 'Mama', '607 490/R', 'Enseignant-Chercheur', 1, 2, 6, '77 560 74 99', NULL, '607 490/R'),
(767, 'SALL', 'Fatou DIOP', '101 204/D', 'Enseignant-Chercheur', 1, 2, 5, '77 636 74 47', NULL, '101 204/D'),
(768, 'SALL', 'Saïdou Moustapha', '104 069/B', 'Enseignant-Chercheur', 1, 9, 6, '77 538 54 59', NULL, '104 069/B'),
(769, 'SAMBE', 'Falilou Mbacké', '104 074/E', 'Enseignant-Chercheur', 1, 2, 6, '77 510 57 07', NULL, '104 074/E'),
(770, 'SAMBOU', 'Vincent', '103 728/I', 'Enseignant-Chercheur', 1, 2, 10, '77 819 29 10', NULL, '103 728/I'),
(771, 'SARR', 'Oumar', '103 948/I', 'Enseignant-Chercheur', 1, 3, 8, NULL, NULL, '103 948/I'),
(772, 'SECK', 'Mamadou Amadou', '104 085/H', 'Enseignant-Chercheur', 1, 2, 6, '77 630 80 17', NULL, '104 085/H'),
(773, 'SECK', 'Mame  Ndella', '103 145/B', 'Enseignant-Chercheur', 1, 4, 8, '77 639 50 58', NULL, '103 145/B'),
(774, 'SECK', 'Mohamed Tidiane', '104 083/J', 'Enseignant-Chercheur', 1, 2, 8, '77 569 17 49', NULL, '104 083/J'),
(775, 'SENE', 'Ndeye Awa', '106 348/Z', 'Enseignant-Chercheur', 1, 5, 10, '77 653 90 55', NULL, '106 348/Z'),
(776, 'SIMEN', 'Serge Francis', '100 983/C', 'Enseignant-Chercheur', 1, 5, 5, '77 676 97 07', NULL, '100 983/C'),
(777, 'SOUARE', 'Cheikhou', '104 387/C', 'Enseignant-Chercheur', 1, 10, 5, '77 541 16 35', NULL, '104 387/C'),
(778, 'SOW', 'Abdoulaye', '104 412/Z', 'Enseignant-Chercheur', 1, 2, 6, '77 534 71 25', NULL, '104 412/Z'),
(779, 'SOW', 'Amy GASSAMA', '102 492/F', 'Enseignant-Chercheur', 1, 11, 6, '77 641 80 33', NULL, '102 492/F'),
(780, 'SOW', 'Demba', '104 446/A', 'Enseignant-Chercheur', 1, 9, 6, '77 569 71 79', NULL, '104 446/A'),
(781, 'SOW', 'Gustave', '104 508/H', 'Enseignant-Chercheur', 1, 2, 4, '77 654 55 40', NULL, '104 508/H'),
(782, 'SY', 'Abdoulaye', '104 511 /', 'Enseignant-Chercheur', 1, 4, 4, '77 646 32 53', NULL, '104 511 /'),
(783, 'TALL', 'Khaly', '104 669/D', 'Enseignant-Chercheur', 1, 2, 4, '77 560 27 55', NULL, '104 669/D'),
(784, 'THIAM', 'Ababacar', '603 370/M', 'Enseignant-Chercheur', 1, 12, 7, '77 551 69 04', NULL, '603 370/M'),
(785, 'THIAM', 'Mamadou Moustapha', '104 779/D', 'Enseignant-Chercheur', 1, 10, 5, '77 639 49 92', NULL, '104 779/D'),
(786, 'THIAW', 'Lamine', '104 808/K', 'Enseignant-Chercheur', 1, 2, 4, '77 658 59 97', NULL, '104 808/K'),
(787, 'TIDJANI', 'Bassirou', '104 811/C', 'Enseignant-Chercheur', 1, 1, 5, '77 644 58 85', NULL, '104 811/C'),
(788, 'TINE', 'Emmanuel', '104 816/H', 'Enseignant-Chercheur', 1, 2, 6, '77 645 28 20', NULL, '104 816/H'),
(789, 'TOURE', 'Alioune', '510 511/A', 'Enseignant-Chercheur', 1, 7, 5, NULL, NULL, '510 511/A'),
(790, 'TOURE', 'Coumba Kane', '104 879/E', 'Enseignant-Chercheur', 1, 1, 6, '77 637 22 66', NULL, '104 879/E');

-- --------------------------------------------------------

--
-- Structure de la table `agent_externe`
--

CREATE TABLE IF NOT EXISTS `agent_externe` (
  `idAgentExterne` int(30) NOT NULL AUTO_INCREMENT,
  `idAgent` int(30) DEFAULT NULL,
  `idStructure` int(30) DEFAULT NULL,
  PRIMARY KEY (`idAgentExterne`),
  KEY `fk_agentExterne_agents` (`idAgent`),
  KEY `fk_agentExterne_Structure` (`idStructure`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4 ;

--
-- Contenu de la table `agent_externe`
--

INSERT INTO `agent_externe` (`idAgentExterne`, `idAgent`, `idStructure`) VALUES
(2, 703, 4),
(3, 697, 4);
...
INSERT INTO `agent_pats` (`N°`, `PRENOMS`, `NOM`, `MledeSolde`, `GRADE`, `FONCTIONS`, `agence`, `TELEPHONE`, `EMAIL`) VALUES
...
INSERT INTO `classe` (`idClasse`, `libClasse`, `codeClasse`, `idFormation`) VALUES
(2, 'DIC2 EEAI', 'DIC2 EEAI', 3),
(3, 'DIC1 EEAI', 'DIC1 EEAI', 3),
(4, 'DUT1 EEAI', 'DUT1 EEAI', 1),
(5, 'DUT2 EEAI', 'DUT2 EEAI', 1),
(6, 'DIC3 EEAI', 'DIC3 EEAI', 3),
(7, 'L1 DEA/EST', 'L1 DEA/EST', 2),
(8, 'DUT1 EEAIT/A1', 'DUT1 EEAIT', 1),
(9, 'DUT1 EEAIT/B', 'DUT1 EEAIT', 1),
(10, 'DUT2 EEAIT/B', 'DUT2 EEAIT', 1),
(11, 'LP EST', 'LP EST', 61),
(12, 'LP DE&A', 'LP DE&A', 4),
(13, 'DUT2 EEAIT/B1', 'DUT2 EEAIT', 1);
...
CREATE TABLE IF NOT EXISTS `formation` (
  ...
  `idTypeFormation` int(30) DEFAULT NULL,
  PRIMARY KEY (`idFormation`),
  KEY `fk_TypeFormation_Formation` (`idTypeFormation`)
...
INSERT INTO `formation` (`idFormation`, `idDepartement`, `libFormation`, `duree`, `codeFormation`, `idTypeFormation`) VALUES
(1, 4, 'DUT en Electronique, Electrotechnique et Automatique Informatique industrielle et Télécommunications (EEAIT)', '', 'EEAIT', 1),
(2, 4, 'Licence en Electronique et Systèmes  de Télécommunications/Distribution Electrique & Automatismes ', '', 'DEA/EST', 2),
(3, 4, 'DIC en Electronique, Electrotechnique et Automatique Informatique industrielle (EEAI)', '', '', 1),
(4, 4, 'Licence Distribution Electrique & Automatismes ', '', 'DEA', 2),
(5, 8, 'DUT en Informatique', '', '', 1),
(6, 8, 'DUT en Télécommunications et Réseaux', '', '', 1),
(7, 8, 'DST en Informatique', '', '', 2),
(8, 8, 'DST en Télécommunications et Réseaux', '', '', 2),
(9, 8, 'Licence Informatique, Télécommunications et Réseaux', '', '', 2),
(10, 8, 'Licence Télé-informatique', '', '', 2),
(11, 8, 'DIC en Télécommunications et Réseaux', '', '', 1),
(12, 8, 'DIC en Informatique  ', '', '', 1),
(13, 8, 'Licence Informatique, Télécommunications et Réseaux', '', '', 2),
(14, 8, 'Licence Télé-informatique', '', '', 2),
(15, 8, 'DIT en Informatique  ', '', '', 1),
(16, 8, 'Master Télécommunications et Réseaux ', '', '', 2),
(17, 8, 'Master Global e-Business', '', '', 2),
(18, 7, 'DUT en Génie Mécanique et Systèmes Industriels', '', '', 1),
(19, 7, 'Licence en Gestion des Systèmes Industriels et de la Production', '', '', 2),
(20, 7, 'DIC en Génie Mécanique et Systèmes Industriels', '', '', 1),
(21, 7, 'Master en  Gestion des Systèmes Industriels et de la Production', '', '', 2),
(22, 5, 'DUT en Finances-Comptabilité', '', '', 1),
(23, 5, 'DUT en Techniques de Commercialisation', '', '', 1),
(24, 5, 'DST en Comptabilité et Gestion des Organisations', '', '', 2),
(25, 5, 'Licence en Sciences et Techniques Comptable et Financière', '', '', 2),
(26, 5, 'Licence en Banque-Finance-Assurance', '', '', 2),
(27, 5, 'Licence en Marketing et Action Commerciale', '', '', 2),
(28, 5, 'Licence en Marketing des Affaires Internationales', '', '', 2),
(29, 5, 'Licence en Gestion Hôtelière et Touristique', '', '', 2),
(30, 5, 'Licence en Gestion des Ressources Humaines', '', '', 2),
(31, 5, 'DESCAF (Diplôme d’Etudes Supérieures en Commerce et Administration Financière)', '', '', 1),
(32, 5, 'Master en Gestion Hôtelière et Touristique', '', '', 2),
(33, 5, 'Master en Gestion des Ressources Humaines', '', '', 2),
(34, 5, 'Master en Contrôle Comptabilité et Audit', '', '', 2),
(35, 5, 'Master en Gestion des Institutions Financières', '', '', 2),
(36, 5, 'Master en Gestion Commerciale', '', '', 2),
(37, 5, 'Master en Gestion des Ressources Humaines', '', '', 2),
(38, 5, 'Master en Commerce Marketing et Management des Affaires Internationales (double diplomation avec Lille)', '', '', 2),
(39, 5, 'Master Gestion de la Mobilité, des Transports et de la Logistique', '', '', 2),
(40, 5, 'DEC (Diplôme Elémentaire Comptable)', '', '', 1),
(41, 5, 'DSC (Diplôme Supérieur Comptable)', '', '', 2),
(42, 5, 'DSECG (Diplôme Supérieur des Etudes Comptables et de Gestion)', '', '', 2),
(43, 10, 'DST en Génie Civil', '', '', 2),
(44, 10, 'DUT en Génie Civil', '', '', 1),
(45, 10, 'DIT en Génie Civil', '', '', 1),
(46, 10, 'Licence en METERBAT', '', '', 2),
(47, 10, 'Licence en Conducteur des Travaux', '', '', 2),
(48, 10, 'Licence en Géométrie', '', '', 2),
(49, 10, 'DIC en Génie Civil', '', '', 1),
(50, 6, 'DST  en Biologie Appliquée', '', '', 2),
(51, 6, 'DST en  Industries Chimiques et Agroalimentaires', '', '', 2),
(52, 6, 'DIT  en Génie Biologique et Sanitaire', '', '', 1),
(53, 6, 'DUT  en Analyses Biologiques', '', '', 1),
(54, 6, 'DUT en  Industries  Alimentaires', '', '', 1),
(55, 6, 'DUT en  Génie Chimique', '', '', 1),
(56, 6, 'DIT  en Génie Chimique', '', '', 1),
(57, 6, 'DIT  en  Industries Chimiques et Agroalimentaires', '', '', 1),
(58, 6, 'Licence en Qualité Hygiène Sécurité et Environnement', '', '', 2),
(59, 6, 'Master en  Qualité Sécurité et Environnement', '', '', 2),
(61, 4, 'Licence en Electronique et Systèmes  de Télécommunications', '', 'EST', 2);
...
--
-- Structure de la table `historiqueaffectation`
--

CREATE TABLE IF NOT EXISTS `historiqueaffectation` (
  `idHistorique` int(30) NOT NULL AUTO_INCREMENT,
  `idAgent` int(30) DEFAULT NULL,
  `idMatiere` int(30) DEFAULT NULL,
  `idClasse` int(30) DEFAULT NULL,
  `libJour` varchar(30) DEFAULT NULL,
  `libMois` varchar(30) DEFAULT NULL,
  `libAnnee` varchar(30) DEFAULT NULL,
  `CM` int(30) DEFAULT NULL,
  `TP` int(30) DEFAULT NULL,
  `TD` int(30) DEFAULT NULL,
  `libelleCours` text,
  PRIMARY KEY (`idHistorique`),
  KEY `fk_Agent_Historique` (`idAgent`),
  KEY `fk_Matiere_Historique` (`idMatiere`),
  KEY `fk_Classe_Historique` (`idClasse`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=26 ;

--
-- Contenu de la table `historiqueaffectation`
--

INSERT INTO `historiqueaffectation` (`idHistorique`, `idAgent`, `idMatiere`, `idClasse`, `libJour`, `libMois`, `libAnnee`, `CM`, `TP`, `TD`, `libelleCours`) VALUES
(2, 751, 14, 7, '29', '9', '2014', 2, 0, 2, NULL),
(3, 691, 19, 7, '29', '9', '2014', 3, 0, 0, NULL),
(4, 751, 14, 7, '18', '10', '2014', 1, 0, 1, NULL),
(5, 691, 19, 7, '18', '10', '2014', 2, 0, 2, NULL),
(7, 751, 14, 7, '20', '10', '2014', 0, 0, 2, NULL),
(9, 691, 19, 7, '20', '10', '2014', 1, 0, 0, NULL),
(10, 751, 14, 7, '21', '11', '2014', 1, 0, 1, NULL),
(11, 691, 19, 7, '21', '11', '2014', 1, 0, 2, NULL),
(13, 691, 19, 7, '21', '11', '2014', 2, 0, 0, NULL),
(14, 708, 14, 7, '21', '11', '2014', 2, 0, 2, NULL),
(15, 708, 14, 7, '11', '12', '2014', 2, 0, 3, NULL),
(17, 717, 18, 7, '11', '12', '2014', 2, 0, 2, NULL),
(18, 717, 18, 7, '26', '12', '2014', 0, 0, 2, NULL),
(20, 708, 14, 7, '16', '1', '2015', 1, 0, 0, NULL),
(21, 717, 18, 7, '16', '1', '2015', 0, 0, 1, NULL),
(22, 708, 14, 7, '17', '01', '2015', 0, 0, 0, 'uyruu'),
(23, 781, 14, 7, '17', '10', '2014', 0, 1, 0, 'Système de Bla bla'),
(24, 781, 14, 7, '19', '11', '2014', 0, 1, 0, ''),
(25, 781, 14, 7, '19', '11', '2014', 0, -1, 0, NULL);
...
INSERT INTO `matiere` (`idMatiere`, `libMatiere`, `idClasse`, `idSemestre`, `codeMatiere`, `coefMatiere`, `CM`, `TP`, `TD`) VALUES
(2, 'Maths', 2, 1, NULL, NULL, 20, NULL, 10),
(3, 'Maths', 3, 3, NULL, NULL, 60, NULL, 30),
(4, 'Maths', 4, 3, NULL, NULL, NULL, 48, 28),
(5, 'Maths', 5, 1, NULL, NULL, NULL, 24, NULL),
(6, 'Maths', 4, 3, NULL, NULL, 48, NULL, 28),
(7, 'Maths', 5, 1, NULL, NULL, 24, NULL, 56),
(8, 'Gestion', 2, 2, NULL, NULL, 20, NULL, 10),
(9, 'Gestion', 6, 1, NULL, NULL, 20, NULL, 10),
(10, 'Circuits et composants linéaires', 7, 1, NULL, NULL, 20, 15, 10),
(11, 'Distribution et sécurité', 7, 1, NULL, NULL, NULL, 15, 10),
(12, 'Fonctions fondamentales de l’électronique ', 7, 2, NULL, NULL, NULL, 15, NULL),
(13, 'Systèmes du 2ème ordre, filtres ', 7, 2, NULL, NULL, NULL, 15, NULL),
(14, 'Mathématique 11', 7, 1, NULL, NULL, 20, NULL, 10),
(15, 'Mathématique 12', 7, 2, NULL, NULL, 20, NULL, 10),
(16, 'Mathématique 21', 7, 1, NULL, NULL, 20, NULL, 10),
(17, 'Mathématique 22', 7, 2, NULL, NULL, 20, 10, 10),
(18, 'Algorithmique, Programmation (C )', 7, 1, NULL, NULL, 10, NULL, 10),
(19, 'Systèmes du 2ème ordre, filtres ', 7, 1, NULL, NULL, 20, NULL, 10),
(20, 'Anglais', 4, 3, NULL, NULL, NULL, NULL, 60),
(21, 'Anglais', 3, 1, NULL, NULL, NULL, NULL, 30),
(22, 'Techniques de communication', 3, 3, NULL, NULL, NULL, NULL, 60),
(23, 'Techniques de communication', 2, 1, NULL, NULL, NULL, NULL, 30),
(24, 'Techniques de communication', 4, 1, NULL, NULL, NULL, NULL, 60),
(25, 'Techniques de communication', 5, 1, NULL, NULL, NULL, NULL, 30),
(26, 'Legislation', 6, 1, NULL, NULL, 20, NULL, 10),
(27, 'Management gestion de projet', 3, 3, NULL, NULL, 20, NULL, 10),
(29, 'Qualité de l''énergie, mesure ', 12, 2, NULL, NULL, NULL, 40, NULL),
(30, 'Système d’exploitation UNIX - Windows Server ', 11, 1, NULL, NULL, NULL, 20, NULL),
(31, 'Technologie IP et protocoles de communication', 11, 1, NULL, NULL, NULL, 30, NULL),
(32, 'Administration et sécurité des réseaux', 11, 2, NULL, NULL, NULL, 10, NULL),
(33, 'GSM', 11, 1, NULL, NULL, NULL, 10, NULL),
(34, 'Conversion de l''énergie', 12, 1, NULL, NULL, NULL, 20, NULL),
(35, 'Circuits et composants linéaires', 7, 1, NULL, NULL, NULL, 30, NULL),
(36, 'Distribution et sécurité', 7, 2, NULL, NULL, NULL, 24, NULL),
(37, 'Inductances et transformateurs', 7, 2, NULL, NULL, NULL, 30, NULL),
(38, 'Analyse et synthèse des systèmes logiques', 7, 1, NULL, NULL, NULL, 30, NULL),
(39, 'FPGA', 5, 2, NULL, NULL, NULL, 24, NULL),
(40, 'Informatique industrielle - Programmation', 12, 3, NULL, NULL, NULL, 30, NULL),
(41, 'Informatique industrielle - Programmation', 12, 1, NULL, NULL, NULL, 30, NULL),
(42, 'Systèmes embarqués ', 11, 2, NULL, NULL, NULL, 15, NULL),
(43, 'Fonctions fondamentales de l''électronique', 7, 2, NULL, NULL, NULL, 15, NULL),
(44, 'Systèmes du 2ème ordre, filtres', 7, 2, NULL, NULL, NULL, 15, NULL),
(45, 'Fonctions et composants élémentaires de l''électronique', 7, 1, NULL, NULL, NULL, 15, NULL),
(46, 'Fonctions associés aux Systèmes de télécommunication', 11, 1, NULL, NULL, NULL, 15, NULL),
(47, 'Antennes et propagation ', 11, 2, NULL, NULL, NULL, 10, NULL),
(48, 'Transmission Numérique', 11, 2, NULL, NULL, NULL, 30, NULL),
(49, 'Distribution et sécurité', 7, 2, NULL, NULL, NULL, 15, NULL),
(50, 'Machines à courant continu et redressement', 12, 2, NULL, NULL, NULL, 30, NULL),
(51, 'Convertisseurs', 12, 1, NULL, NULL, NULL, 15, NULL),
(52, 'Energies renouvelables', 12, 1, NULL, NULL, 10, 15, NULL),
(53, 'Conversion de l''énergie', 12, 1, NULL, NULL, NULL, 20, NULL),
(54, 'Machines électriques', 12, 2, NULL, NULL, NULL, 18, NULL),
(55, 'Anglais', 8, 3, NULL, NULL, NULL, NULL, 60),
(56, 'Techniques de communication', 9, 1, NULL, NULL, NULL, NULL, 60),
(57, 'FPGA', 13, 2, 'FPGA', NULL, NULL, 24, NULL);
...
CREATE TABLE IF NOT EXISTS `role` (
  ...
  `ClassePassword` varchar(50) NOT NULL,
  PRIMARY KEY (`idRole`),
...
INSERT INTO `role` (`idRole`, `idAgent`, `idTypeRole`, `classe`, `ClassePassword`) VALUES
(1, 686, 1, '', ''),
(3, 725, 3, '', ''),
(4, 690, 3, '', ''),
(5, 734, 3, '', ''),
(6, 722, 3, '', ''),
(7, 758, 3, '', ''),
(33, 720, 4, 'L1 DEA/EST', 'passer'),
(34, 751, 4, 'DUT1 EEAI', ''),
(35, 749, 4, 'DIC2 EEAI', ''),
(36, 708, 4, 'DUT2 EEAIT/B', ''),
(37, 742, 3, '', ''),
(38, 293, 7, '', '');
...
CREATE TABLE IF NOT EXISTS `semestre` (
  ...
  `libSemestre` varchar(30) NOT NULL,
...
INSERT INTO `semestre` (`idSemestre`, `libSemestre`) VALUES
(1, 'S1'),
(2, 'S2'),
(3, 'S12');
...
CREATE TABLE IF NOT EXISTS `typeformation` (
  `idTypeFormation` int(30) NOT NULL AUTO_INCREMENT,
  `libTypeFormation` varchar(50) DEFAULT NULL,
...
INSERT INTO `typeformation` (`idTypeFormation`, `libTypeFormation`) VALUES
(1, 'Formation Initial'),
(2, 'Formation Payante');
...
--
-- Contraintes pour la table `agent_externe`
--
ALTER TABLE `agent_externe`
  ADD CONSTRAINT `fk_agentExterne_agents` FOREIGN KEY (`idAgent`) REFERENCES `agents` (`idAgent`),
  ADD CONSTRAINT `fk_agentExterne_Structure` FOREIGN KEY (`idStructure`) REFERENCES `structure` (`idStructure`);
...
ALTER TABLE `formation`
  ADD CONSTRAINT `fk_TypeFormation_Formation` FOREIGN KEY (`idTypeFormation`) REFERENCES `typeformation` (`idTypeFormation`);

--
-- Contraintes pour la table `historiqueaffectation`
--
ALTER TABLE `historiqueaffectation`
  ADD CONSTRAINT `fk_Agent_Historique` FOREIGN KEY (`idAgent`) REFERENCES `agents` (`idAgent`),
  ADD CONSTRAINT `fk_Classe_Historique` FOREIGN KEY (`idClasse`) REFERENCES `classe` (`idClasse`),
  ADD CONSTRAINT `fk_Matiere_Historique` FOREIGN KEY (`idMatiere`) REFERENCES `matiere` (`idMatiere`);
...
ALTER TABLE `matiere`
  ...
  ADD CONSTRAINT `fk_Semestre` FOREIGN KEY (`idSemestre`) REFERENCES `semestre` (`idSemestre`);
