          ...
          <thead>
            <tr>
              ...
              <th>
				...
				<div id="modalEnseignement1_<?php echo $z ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					 <h3>Affectation Enseignement</h3>
					</div>
					 <div class="modal-body" id="myModalLabel">
						<p>L'Enseignant selectionné sera verra Affecté comme Enseignant de <strong> <?php echo $MatiereData2[$i][$z][1] ?> </strong> dans la Classe <strong> <?php echo $Classe[$i] ?> </strong> avec les privilèges et responsabilités qui accompagnent cette Affectation !</p>
					 </div>
				...
				<tr class=''> <input name="idMatiere" type="hidden" value ="<?php echo  $MatiereData2[$i][$z][0]  ?>" > <td width='' > <?php echo $MatiereData2[$i][$z][1] ?> </td><td id="CM_initial"><?php echo $MatiereData2[$i][$z][2] ?></td><td id="TD_initial" ><?php echo $MatiereData2[$i][$z][3] ?></td><td id="TP_initial"> <?php echo $MatiereData2[$i][$z][4] ?> </td><td width=''> 
				...
				<td>
					<div class="pull-right">
						<button  class="btn btn-primary" data-toggle="modal" data-target="#modalEnseignement1_<?php echo $z ?>"> Affecter</button>
					</div>
				</td>
				</tr>	
