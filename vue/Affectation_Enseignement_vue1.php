          ...
          <thead>
            <tr>
              ...
              <th>TP
					...
					<?php for ($z = 0; $z <count($MatiereData1[0]); $z++) { ?>
					
				 <tr class=''> <td width='' > <?php echo $MatiereData1[0][$z][1] ?> </td><td><?php echo $MatiereData1[0][$z][2] ?></td><td ><?php echo $MatiereData1[0][$z][3] ?></td><td> <?php echo $MatiereData1[0][$z][4] ?> </td><td width=''> 
          ...
          <thead>
            <tr>
              ...
              <th>TP
				...
				<tr class=''> <td width='' > <?php echo $MatiereData1[$i][$z][1] ?> </td><td><?php echo $MatiereData1[$i][$z][2] ?></td><td ><?php echo $MatiereData1[$i][$z][3] ?></td><td> <?php echo $MatiereData1[$i][$z][4] ?> </td><td width=''> 
