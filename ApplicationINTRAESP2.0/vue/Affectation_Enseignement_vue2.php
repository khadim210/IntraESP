<div class="tabbable">
		...
		for ($i = 1; $i <= count($Classe)-1; $i++) {
         ...
         <div class="tab-content">
                  <div class="tab-pane active" id="tabS3_1">
          ...
          <thead>
            <tr>
              ...
              <th>TP
					...
					<?php for ($z = 0; $z <count($MatiereData3[0]); $z++) { ?>
					
				 <tr class=''> <td width='' > <?php echo $MatiereData3[0][$z][1] ?> </td><td><?php echo $MatiereData3[0][$z][2] ?></td><td ><?php echo $MatiereData3[0][$z][3] ?></td><td> <?php echo $MatiereData3[0][$z][4] ?> </td><td width=''> 
			...
			<?php
					...
					for ($i = 1; $i <= count($Classe)-1; $i++) {
						...
						echo '<div class="tab-pane" id="tabS3_'.$y.'">';
          ...
          <thead>
            <tr>
              ...
              <th>TP
				...
				<tr class=''> <td width='' > <?php echo $MatiereData3[$i][$z][1] ?> </td><td><?php echo $MatiereData3[$i][$z][2] ?></td><td ><?php echo $MatiereData3[$i][$z][3] ?></td><td> <?php echo $MatiereData3[$i][$z][4] ?> </td><td width=''> 
